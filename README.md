...
On successful completion, you will see the following message
   ...
   module.storagenode.null_resource.iscsi_storage[1] (remote-exec): 100.0%

   module.storagenode.null_resource.iscsi_storage[1]: Creation complete after 40s (ID: 1149023838829166501)
...
This step includes the following: 
* Prepare the Master, Infra, App, Storage, Tower nodes before installing OpenShift
